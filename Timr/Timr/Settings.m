...
+ (Settings *)sharedSettings{
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSMutableArray *notifications = [[sharedInstance.userDefaults objectForKey:@"notifications"] mutableCopy];
        if(notifications == nil) notifications = [NSMutableArray arrayWithCapacity:18];
        sharedInstance.notificationValues = notifications;
    });
